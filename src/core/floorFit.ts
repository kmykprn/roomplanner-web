 ...
 *
 * 傾きは、床の上の四隅から解く（core/floorCorners.ts）。
 * 高さ（カメラから床まで）は、辺の長さを入れてもらえばそこから決まり、無ければ 1.4 m。
 * 写真 1 枚からは実際の寸法が決まらないので、立って撮った前提を置いている。
 */
...
/** カメラから床までの高さ（m）の既定。立って撮った前提。長さを入れてもらえなかったときに使う */
